...
public class TimeFormatUtil {
    ...
    public static String formatLocalDateTime2String(LocalDateTime localDateTime) {
        return LocalDateTimeUtil.format(localDateTime, DatePattern.CHINESE_DATE_TIME_PATTERN);
    }
